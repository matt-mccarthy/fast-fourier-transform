...
For our test we took, $\mathcal{N}=\set{2^{17},2^{19},2^{21},2^{23},2^{25},2^{27}}$ and $\mathcal{T}=\set{1,4,16,64,256,1024}$, all of which are less than the number of cores on our GTX 970.
